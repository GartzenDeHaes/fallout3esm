...
namespace TES3Unity.NIF
{
    public class NiReaderUtils
    {
        ...
        public static T Read<T>(UnityBinaryReader reader)
        {
            ...
            {
                return (T)((object)reader.ReadLength32PrefixedASCIIString());
            }
            else if (typeof(T) == typeof(Vector3))
            {
                return (T)((object)reader.ReadVector3());
            }
            else if (typeof(T) == typeof(Quaternion))
            {
                return (T)((object)reader.ReadQuaternionWFirst());
            }
        ...
        public static NiObject ReadNiObject(UnityBinaryReader reader)
        {
            ...
            var nodeTypeBytes = reader.ReadLength32PrefixedBytes();
        ...
        {
            return reader.ReadRowMajorMatrix3x3();
        }
    }
}
